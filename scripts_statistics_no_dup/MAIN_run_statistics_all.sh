...
LOGDIR="/mnt/raidproj/proj/projekte/personalizedmed/PPG/miRNAs/scripts_statistics_no_dup/logs"
CHUNKFILE="/mnt/raidproj/proj/projekte/personalizedmed/PPG/miRNAs/chromosome_list.txt"
SCRIPT="/mnt/raidproj/proj/projekte/personalizedmed/PPG/miRNAs/scripts_statistics_no_dup/run_statistics_family.py"
