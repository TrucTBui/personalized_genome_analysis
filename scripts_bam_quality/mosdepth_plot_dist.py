...
def main():
    ...
    #args.input is atext file, each line is a file name
    # each file name is a mosdepth global.dist.txt file
    ...
    for f in input_files:
        ...
        path = f.replace(".mosdepth.global.dist.txt", "")
...
def get_args():
    ...
    parser.add_argument("-i", "--input",
                        help="the txt file containing paths to dist file(s) to use for plotting")
