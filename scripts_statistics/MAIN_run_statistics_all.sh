...
LOGDIR="/mnt/raidproj/proj/projekte/personalizedmed/PPG/miRNAs/scripts_statistics/logs"
CHUNKFILE="/mnt/raidproj/proj/projekte/personalizedmed/PPG/miRNAs/chunk_list.txt"
SCRIPT="/mnt/raidproj/proj/projekte/personalizedmed/PPG/miRNAs/scripts_statistics/run_statistics_family.py"
